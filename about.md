...
| 기간 | 소속 | 담당 |
|---|---|---|
| 2026.05 - 현재 | 개인·오픈소스 개발 | Flower, Bloom, AI Harness, Action Runtime과 두 개의 Agent Skill 개발·공개 |
| 2026.05 - 현재 | ArchDox · 개인 개발 | 건축사사무소용 문서 관리·AI 문서 생성·MCP 플랫폼 개발 및 AWS 운영 |
| 2023.01 - 현재 | 토탈소프트뱅크 연구소 · 선임 | 항만 자동화 시스템 유지보수, 신규 사이트 개발, 장비 제어 프로그램 및 검증 도구 개발 |
